...
<body>
	...
	<section id="geral">
		<div class="cadastro">
			<div id="panel">
			<h1>Cadastro do Funcionário</h1> <p><br><p>
				<!-- Abaixo Form para Validar em JS-->
                <form id="myForm" onsubmit="return validateForm()"  
				action="cad_fun.php" method="POST"> <!-- Post em PHP para o banco de dados SQL-->
					<table> <tr>
						<td>Nome:</td> 
					...
					<tr>
						...
						<td>
							<input type="text" name="dn" placeholder="YYYY-MM-DD" oninput="formatDate(this)"></td>
					</tr>
					<tr>
						<td>Sexo:</td> 
						<td>
